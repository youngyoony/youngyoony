...
- NYC Building Permit Clustering with MPI: Implemented MPI-parallelized K-Means and Hierarchical clustering on 1.8M+ NYC building permits using SeaWulf HPC, achieving 7.6x speedup. Includes Amdahl's Law analysis and geographic visualization. *[Link](https://github.com/youngyoony/NYC-Permit-Clustering-MPI)*
...
> Python, SQL, Django, FastAPI, Spark, Kafka, Airflow, Tableau, NetworkX, LangChain, and MPI.
